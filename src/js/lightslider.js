                ...
                refresh.createPager = function () {
                    ...
                    for (i = 0; i < length; i++) {
                        ...
                        if (settings.gallery === true) {
                            pagers += '<li style="width:100%;' + property + ':' + thumbWidth + 'px;' + gutter + ':' + settings.thumbMargin + 'px"><i class=" fas fa-circle dot_sliders" style="font-size:'+(thumbWidth*0.8)+'px;"></i></li>';
                        } else {
